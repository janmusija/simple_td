...
function Mana_Orb:new(state,x,y,mods)
    ...
    self.sprite = mods.sprite or Mana_Orb.sprite
    self.production_size = mods.production_size or 10 -- produce mana in packets of this size
    self.production_period = mods.production_period or 21*60 -- in seconds
    self.tick_countdown = mods.tick_countdown or 7*60 -- first packet of mana produced in 5 seconds
    -- yes, I chose these values arbitrarily. they are subject to change
end

Mana_Orb.sprite = love.graphics.newImage("sprite/tower/mana_orb.png")
